...
#import "UIImageView+FNWebImage.h"
...
- (void)updateWithImage:(FNFullScreenImage *)fullImage completion:(void (^)(NSError *))completion
{
    if (fullImage.image) {
        ...
        [self.imageView fn_setImageWithURL:[NSURL URLWithString:fullImage.imageURLString] placeholder:self.placeHolderImage completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
